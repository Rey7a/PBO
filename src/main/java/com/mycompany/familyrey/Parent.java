...
public class Parent implements Person {
    ...
    public Parent(String nama, String tempatLahir, String tanggalLahir, String pekerjaan, String tempatTinggal) {
        this.nama = nama;
    ...
    private int hitungUmur(String tanggalLahir) {
        try {
            ...
            System.out.println("Error parsing tanggal lahir: " + tanggalLahir);
            e.printStackTrace();
            return -1;
        }
    }
